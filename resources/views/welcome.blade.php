            ...
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                ...
                @else
                    <a href="{{ route('login') }}" class="text-sm text-gray-700 dark:text-gray-500 "><button
                            class="p-3 bg-black text-white font-semibold ">Login</button></a>

                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500"><button
                                class="p-3 text-white font-semibold ">Register</button></a>
                    @endif
                @endauth
            </div>
        @endif
